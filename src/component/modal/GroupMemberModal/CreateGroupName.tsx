...
const CreateGroupName = ({
  ...
  const KEYBOARD_TOP_GAP = 12; // Comfortable gap between bar and keyboard

  useEffect(() => {
    const showSub = Keyboard.addListener(
      Platform.OS === 'ios' ? 'keyboardWillShow' : 'keyboardDidShow',
      (e) => setKeyboardHeight(e.endCoordinates.height + KEYBOARD_TOP_GAP)
    );
  ...
  return (
    <View style={[styles.keyboardAvoid, { bottom: keyboardHeight }]} pointerEvents="box-none">
      {content}
    </View>
  );
};
